...
class RbacController extends Controller
{
    ...
    /**
     * Deletes not needed permissions and roles. Makes reassigns of member role to admin.
    ...
    /**
     * Shows message about remove result.
     *
     * @param bool $removed Whether object was removed.
     * @param string $object Name of permission or role
     */
    protected function removedMessage($removed, $object): void
    {
        if ($removed) {
            $this->stdout("\n'$object' removed.\n", Console::FG_GREEN);
        } else {
            $this->stdout("\n'$object' does not removed.\n", Console::FG_RED);
        }
    }
}