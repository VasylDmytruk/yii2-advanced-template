...
class User extends UserIdentity
{
    ...
    public const ROLE_CREATOR = 'theCreator';
...
//------------------------------------------------------------------------------------------------//
    ...
    /**
     * Checks whether it is first signup, whether no user exists.
     *
     * @return bool True if it is first signup.
     */
    public static function firstSignup()
    {
        $user = static::find()->limit(1)->asArray()->one();
        $isFirstSignup = ($user === null) ? true : false;
